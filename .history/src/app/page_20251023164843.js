...
export default function Home() {
  ...
  // Hero parallax image
  useGSAP(() => {
    // If parallax banner is present, it controls its own scroll animations
    const hasParallax = document.querySelector(".parallax-banner");
    ...
    <>
      ...
      <section className="brand-gate">
        <div className="brand-gate-grid">
          ...
          >
            <img src={(activeTheme === "dark" ? LogoWhite : LogoBlack).src} alt="Tomy Rivero Beauty Lab" />
            <h2>Beauty Lab</h2>
          </a>
          <a
            href="/cafe"
          ...
          >
            <img src={(activeTheme === "dark" ? LogoWhite : LogoBlack).src} alt="Tomy Rivero Beauty Café" />
              <h2>Beauty Caf\u00e9</h2>
          </a>
        </div>
      </section>
          ...
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 5.2 : 0.85}>
                <h1>{t("home.hero.title", "Elevate your self‑care experience")}</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 5.35 : 1}>
                <p>{t("home.hero.tagline", "Personalized nail care, rejuvenating skin treatments, and spa services—thoughtfully designed to help you relax, renew, and reveal your best self.")}</p>
              </Copy>
            </div>
            <AnimatedButton
              label={t("topbar.reserve", "Book now")}
              route="/connect"
          ...
          <div className="container">
            <div className="stat">
              ...
              <div className="stat-info">
                <Copy delay={0.15}>
                  <p>{t("home.stats.colors", "Colors to choose from")}</p>
                </Copy>
              </div>
            </div>
            <div className="stat">
              ...
              <div className="stat-info">
                <Copy delay={0.25}>
                  <p>{t("home.stats.satisfaction", "Five‑star client satisfaction")}</p>
                </Copy>
              </div>
            </div>
            <div className="stat">
              ...
              <div className="stat-info">
                <Copy delay={0.35}>
                  <p>{t("home.stats.appointments", "Appointments completed")}</p>
                </Copy>
              </div>
            </div>
            <div className="stat">
              ...
              <div className="stat-info">
                <Copy delay={0.45}>
                  <p>{t("home.stats.cafe", "Beauty Café opens in Inwood")}</p>
                </Copy>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="what-we-do-header">
            <Copy delay={0.1}>
              <h1>
                ...
                {t("home.approach.header", "At Tomy Rivero Beauty, we elevate self‑care with expert nail care, skincare, and spa rituals—crafted for calm, clarity, and a lasting glow.")}
              </h1>
            </Copy>
          </div>
          <div className="what-we-do-content">
            <div className="what-we-do-col">
              ...
              <Copy delay={0.15}>
                <p className="lg">
                  {t("home.approach.lead", "Every service begins with consultation and care. We combine clean techniques, curated products, and practiced hands to create results that feel refined, restorative, and uniquely yours.")}
                </p>
              </Copy>
            </div>
            <div className="what-we-do-col">
              <div className="what-we-do-tags" ref={tagsRef}>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.nailCare", "Nail Care")}</h3>
                </div>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.skincare", "Skincare")}</h3>
                </div>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.spa", "Spa Rituals")}</h3>
                </div>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.clean", "Clean Beauty")}</h3>
                </div>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.expert", "Expert Care")}</h3>
                </div>
                <div className="what-we-do-tag">
                  <h3>{t("home.tags.cafe", "Beauty Café")}</h3>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="featured-projects-container">
        <div className="container">
          <div className="featured-projects-header-callout">
            <Copy delay={0.1}>
              <p>{t("home.featured.callout", "Featured services")}</p>
            </Copy>
          </div>
          <div className="featured-projects-header">
            <Copy delay={0.15}>
              <h2>{t("home.featured.header", "A selection of signature services and treatments")}</h2>
            </Copy>
          </div>
        </div>
        <FeaturedProjects />
      ...
      <section className="client-reviews-container">
        <div className="container">
          <div className="client-reviews-header-callout">
            <p>{t("home.reviews.callout", "Sweet reviews from our customers")}</p>
          </div>
          <ClientReviews />
        </div>
      </section>
      {/* Instagram feed via oEmbed (requires INSTAGRAM_POST_URLS or query) */}
      <InstagramFeed />
        ...
        <div className="container">
          ...
          <div className="gallery-callout-col">
            <div className="gallery-callout-copy">
              <Copy delay={0.1}>
                  <h3>{t("home.gallery.copy", "Take a closer look at the looks and treatments our clients love. From clean, minimalist finishes to expressive nail art and restorative facials—find your next favorite.")}</h3>
              </Copy>
              <AnimatedButton label={t("home.gallery.explore", "Explore gallery")} route="blueprints" />
            </div>
          </div>
        </div>
      </section>
  ...
  header={t("home.cta.header", "Tomy Rivero Beauty")}
  callout={t("home.cta.callout", "Elevate your self‑care")}
  description={t("home.cta.description", "Thoughtful services, expert techniques, and a welcoming space—crafted to help you relax, renew, and leave with that unmistakable glow.")}
      />
      <ConditionalFooter />
    </>
  );
