    ...
    if (showPreloader) {
      ...
      wordEls.forEach((el, index) => {
        ...
        if (index < wordEls.length - 1) {
          tl.to(el, { y: "-120%", duration: 0.7, ease: "power3.inOut" }, "+=1.1");
        }
      });
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 9.2 : 0.85}>
                <h1>Elevate your self‑care experience</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 9.35 : 1}>
                <p>
