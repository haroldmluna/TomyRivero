        ...
        <section className="cafe-hero">
          <div className="container">
            <div className="cafe-hero-col">
              <Copy delay={0.85}><p>{t("cafe.name", "Tomy Rivero Beauty")}</p></Copy>
              <Copy delay={0.9}><h1>{t("cafe.title", "Beauty Caf\u00e9")}</h1></Copy>
              <Copy delay={1}>
                <h3>{t(
                  "cafe.tagline",
              ...
              <div className="cafe-hero-cta">
                <AnimatedButton label={t("cafe.joinWaitlist", "Join the waitlist")} route="/connect" animate={false} />
              </div>
            </div>
            <div className="cafe-hero-col">
          ...
          <div className="container">
            <div className="expect-grid">
              <div className="expect-card">
                <Copy delay={0.1}><h3>{t("cafe.signatureDrinks", "Signature Drinks")}</h3></Copy>
                <Copy delay={0.15}><p className="md">{t("cafe.signatureDrinksDesc", "Seasonal espresso, matcha, and herbal blends—crafted with the same care we bring to every service.")}</p></Copy>
              </div>
              <div className="expect-card">
                <Copy delay={0.2}><h3>{t("cafe.colorRetail", "Color & Retail")}</h3></Copy>
                <Copy delay={0.25}><p className="md">{t("cafe.colorRetailDesc", "A curated beauty bar and 1,000+ color library. Try, learn, and find your next favorite finish.")}</p></Copy>
              </div>
              <div className="expect-card">
                <Copy delay={0.3}><h3>{t("cafe.events", "Events & Workshops")}</h3></Copy>
                <Copy delay={0.35}><p className="md">{t("cafe.eventsDesc", "Talks, demos, and small gatherings—beauty, wellness, and culture in conversation.")}</p></Copy>
              </div>
            </div>
          </div>
        </section>
