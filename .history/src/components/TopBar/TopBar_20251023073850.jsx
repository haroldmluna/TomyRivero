  ...
  return (
    <div className="top-bar" ref={topBarRef}>
      ...
      <div className="top-bar-cta" suppressHydrationWarning style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        ...
        {/*
          Only render translated label after mount to avoid hydration mismatch.
          The server renders a stable fallback (English "Book now") so the
          initial HTML matches between server and client. After mount we
          replace it with the localized string from the i18n context.
        */}
        <AnimatedButton
