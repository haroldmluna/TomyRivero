...
// No GSAP plugin needed for split-type
          ...
          <div className="col col-1">
            <div className="links">
              ...
              <div className="link">
                <a
                  href="/by-look"
                  onClick={(e) => handleLinkClick(e, "/by-look")}
                >
                  <h2>{t("nav.byLook", "By Look")}</h2>
                </a>
              </div>
              <div className="link">
                <a
                ...
                >
                  <h2>{t("nav.giftCards", "Gift Cards")}</h2>
                </a>
              </div>
              <div className="link">
                <a
          ...
          <div className="col col-2">
              ...
              <div className="sub-col">
                <div className="menu-meta menu-commissions">
                  ...
                  <p>{t("connect.bookOnline","Book online")}</p>
                  <p>{t("connect.website","tomyriverobeauty.com")}</p>
                </div>
                <div className="menu-meta">
                  <p>{t("connect.lab","Beauty Lab")}</p>
                  <p>{t("connect.location","Inwood, NYC")}</p>
                  <p>{t("connect.cafeOpening","Beauty Café opens Fall ’25")}</p>
                </div>
              </div>
              <div className="sub-col">
                <div className="menu-meta">
                  <p>{t("nav.social","Social")}</p>
                  <p>{t("nav.instagram","Instagram")}</p>
                  <p>{t("nav.arena","Are.na")}</p>
                  <p>{t("nav.linkedin","LinkedIn")}</p>
                </div>
              </div>
            </div>
          </div>
