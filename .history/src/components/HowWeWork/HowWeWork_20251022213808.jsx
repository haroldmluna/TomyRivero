        ...
        <div className="container">
          <div className="how-we-work-header-content">
            <div className="how-we-work-header-callout">
              <Copy delay={0.1}>
                <p>{t("how.callout", "Our service process")}</p>
              </Copy>
            </div>
            <Copy delay={0.15}>
              <h3>{t("how.header", "From consultation to finish, we care for every detail—clean techniques, calm pacing, and results that last.")}</h3>
            </Copy>
            <div className="how-we-work-steps" ref={stepsRef}>
              ...
              >
                <p className="how-we-work-step-label">{t("how.stepLabel","Step")}</p>
        ...
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>{t("how.consultation","Consultation")}</h3>
            </div>
            <p className="md">{t("how.consultationDesc","We start by understanding your goals and preferences—finish, shape, sensitivity, and routine—so the service can be tailored to you.")}</p>
          </div>
        </div>
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>{t("how.cleanPrep","Clean Prep")}</h3>
            </div>
            <p className="md">{t("how.cleanPrepDesc","Meticulous cuticle care and shaping form the foundation. Clean techniques support nail health and set up a flawless finish.")}</p>
          </div>
        </div>
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>{t("how.technique","Technique")}</h3>
            </div>
            <p className="md">{t("how.techniqueDesc","Precise application and even coverage—whether sheer, bold, or art—with attention to symmetry and smooth, lasting wear.")}</p>
          </div>
        </div>
        <div className="how-we-work-card">
          <div className="how-we-work-card-img">
          ...
          <div className="how-we-work-card-copy">
            <div className="how-we-work-card-index-label">
              <h3>{t("how.finish","Finish & Care")}</h3>
            </div>
            <p className="md">{t("how.finishDesc","Choose from glossy or soft-matte. We share simple, effective aftercare to keep your finish looking fresh between visits.")}</p>
          </div>
        </div>
        <div className="how-we-work-cta">
          <AnimatedButton label={t("how.bookNow","Book now")} route="/connect" animate={false} />
        </div>
      </div>
    </div>
  );
