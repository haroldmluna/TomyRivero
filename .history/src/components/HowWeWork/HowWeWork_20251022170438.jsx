        ...
        <div className="container">
          <div className="how-we-work-header-content">
            <div className="how-we-work-header-callout">
              <Copy delay={0.1}>
                <p>Our service process</p>
              </Copy>
            </div>
            <Copy delay={0.15}>
              <h3>
                From consultation to finish, we care for every detail—clean
                techniques, calm pacing, and results that last.
              </h3>
            </Copy>
      ...
      <div className="how-we-work-col how-we-work-cards" ref={cardsRef}>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We start by understanding your goals and preferences—finish,
              shape, sensitivity, and routine—so the service can be tailored to
              you.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              Meticulous cuticle care and shaping form the foundation. Clean
              techniques support nail health and set up a flawless finish.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              Precise application and even coverage—whether sheer, bold, or
              art—with attention to symmetry and smooth, lasting wear.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              Choose from glossy or soft‑matte. We share simple, effective
              aftercare to keep your finish looking fresh between visits.
            </p>
          </div>
        </div>
      </div>
