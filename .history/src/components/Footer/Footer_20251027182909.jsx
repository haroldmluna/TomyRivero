            ...
            <div className="footer-nav-links">
              <Copy delay={0.1}>
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    navigateWithTransition("/by-look");
                  }}
                >
                  <h3>By Look</h3>
                </a>
        ...
        <div className="container">
          <div className="footer-header">
            {(() => {
              ...
              const src = (activeTheme === "dark" ? logoMap[section].dark : logoMap[section].light).src;
              const alt = section === "lab" ? "Tomy Rivero Beauty Lab" : section === "cafe" ? "Tomy Rivero Beauty Café" : "Tomy Rivero Beauty";
          ...
          <div className="footer-copyright">
            ...
            <p>
              <a href="/privacy-policy" onClick={(e)=>{e.preventDefault(); navigateWithTransition("/privacy-policy");}}>Privacy Policy</a>
              <span style={{margin:"0 0.5rem"}}>•</span>
              <a href="/terms" onClick={(e)=>{e.preventDefault(); navigateWithTransition("/terms");}}>Terms of Service</a>
              <span style={{margin:"0 0.5rem"}}>•</span>
              <a href="/cookies" onClick={(e)=>{e.preventDefault(); navigateWithTransition("/cookies");}}>Cookies Policy</a>
            </p>
          </div>
        </div>
      </div>
