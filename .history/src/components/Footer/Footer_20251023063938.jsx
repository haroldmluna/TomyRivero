...
import LogoBlack from "@/SVG/tomy-rivero-beauty-logo-black.svg";
    ...
    <div className="footer">
      <div className="footer-meta">
          ...
          <div className="footer-meta-col">
            <div className="footer-nav-links">
              <Copy delay={0.1}>
                ...
                >
                  <h3>{t("nav.giftCards", "Gift Cards")}</h3>
                </a>
                <a
                  href="/connect"
                  onClick={(e) => {
        ...
        <div className="container footer-socials">
          ...
          <div className="footer-meta-col">
            <Copy delay={0.1}>
              <p>{t("footer.about","We believe beauty is a form of self\u2011care—rooted in expertise, clean techniques, and a calm, welcoming touch.")}</p>
            </Copy>
          </div>
        </div>
      </div>
      <div className="footer-outro">
        <div className="container">
          <div className="footer-header">
            <img src={LogoBlack.src} alt="Tomy Rivero Beauty" />
          </div>
            <div className="footer-copyright">
            <p>{t("footer.cookies","This website is using cookies.")}</p>
            <p>{t("footer.copyright","All rights reserved © 2025")}</p>
          </div>
        </div>
      </div>
    </div>
