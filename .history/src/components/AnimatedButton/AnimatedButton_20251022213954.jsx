...
const AnimatedButton = ({
  ...
  const buttonContent = (
    <>
      ...
      <span className="button-text" ref={textRef} suppressHydrationWarning>
        {label}
      </span>
    </>
  );
  ...
  if (route) {
    return (
      <a
        ...
        onClick={(e) => {
          e.preventDefault();
          track("cta_click", { label: label || "CTA", destination: route });
  ...
  return (
    <button
      className="btn"
      ref={buttonRef}
      onClick={() => track("cta_click", { label: label || "CTA", destination: "button" })}
    >
      {buttonContent}
    </button>
  );
