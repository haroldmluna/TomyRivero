    ...
    <div className="wrapper">
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="actions">
          ...
          {status.ok && <p className="ok">{t("join.form.success","Thanks! We’ll get back to you.")}</p>}
          {status.ok === false && <p className="err">{status.error || t("join.form.error","Something went wrong")}</p>}
        </div>
      </form>
    </div>
  );
